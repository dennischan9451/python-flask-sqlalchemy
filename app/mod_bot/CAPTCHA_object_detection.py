...
PATH_TO_FROZEN_GRAPH = os.path.dirname(os.path.abspath(__file__)) + '\\frozen_inference_graph.pb'
# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = os.path.dirname(os.path.abspath(__file__)) + '\CAPTCHA_labelmap.pbtxt'
NUM_CLASSES = 37
